...
![exist-db CI](https://github.com/maleficulus/tmp/workflows/exist-db%20CI/badge.svg)
...
1.  Download  the `tmp-1.0.0.xar` file from GitHub [releases](https://github.com/maleficulus/tmp/releases) page.
...
GPL-3.0 © [maleficulus](http://exist-db.org)
...
[release-url]: https://github.com/maleficulus/tmp/releases/latest
